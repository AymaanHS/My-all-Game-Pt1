...
mainCyclist.setCollider("rectangle",-1,-1,60,140);
...
function reset()
{
  ...
  console.log("Restart Game");
  gameOver.visible = false;
  mainCyclist.changeAnimation("images/mainPlayer1.png","images/mainPlayer2.png");
  pinkCG.destroyEach(); yellowCG.destroyEach(); redCG.destroyEach();
 distance=0;
  mainCyclist.addAnimation("SahilRunning",mainRacerImg1); 
}
